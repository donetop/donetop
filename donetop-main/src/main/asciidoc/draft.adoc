...
==== createSingle_nonAdminWithoutVerification_return400
.request
include::{snippets}/draft_single_create/createSingle_nonAdminWithoutVerification_return400/http-request.adoc[]
.response
include::{snippets}/draft_single_create/createSingle_nonAdminWithoutVerification_return400/http-response.adoc[]

==== createSingle_nonAdminWithVerification_return200
.request
include::{snippets}/draft_single_create/createSingle_nonAdminWithVerification_return200/http-request.adoc[]
.response
include::{snippets}/draft_single_create/createSingle_nonAdminWithVerification_return200/http-response.adoc[]
