...
HTTP Method : *PUT* +
URI : */api/draft/status/\{draft_id\}*

=== Request body fields description
include::{snippets}/draft_status_update/updateStatus_withDifferentStatus_return200/request-fields.adoc[]
=== Response body fields description
include::{snippets}/draft_status_update/updateStatus_withDifferentStatus_return200/response-fields.adoc[]

=== Examples
==== updateStatus_withSameStatus_return400
.request
include::{snippets}/draft_status_update/updateStatus_withSameStatus_return400/http-request.adoc[]
.response
include::{snippets}/draft_status_update/updateStatus_withSameStatus_return400/http-response.adoc[]

==== updateStatus_withDifferentStatus_return200
.request
include::{snippets}/draft_status_update/updateStatus_withDifferentStatus_return200/http-request.adoc[]
.response
include::{snippets}/draft_status_update/updateStatus_withDifferentStatus_return200/http-response.adoc[]